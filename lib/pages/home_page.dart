...
class HomePage extends KaeruWidget<HomePage> {
  ...
  Setup setup() {
    ...
    return () {
      ...
      final connected =
          s.connectionState.value == ServerConnectionState.connected;
          ...
          child: [
            [
                  ...
                  FilledButton.tonalIcon(
                    ...
                    label:
                        (s.serverRunning.value ? t.serverStop : t.serverStart)
                            .text
                            .make(),
            ...
            [
                  t
                      .totalEvents(
                        (s.totalForwardEvents.value +
                                s.totalBackwardEvents.value)
                            .toString(),
                      )
                      .text
                      .titleMedium
                  ...
                  4.vSpace,
                  t
                      .avgSpeed(s.avgSpeed.value.toStringAsFixed(1))
                      .text
                      .gray(600)
                      .make(),
                ]
